  ...
  try {
    ...
    try {
      await sendEmail({
        ...
        text: `Hello, Your account is been created with us.<br></br><div>Email :- ${email} <br></br> <p>Password:-Kmit123$</p><p>Please visit us at :- http://elb-ubunut1804-1643489929.us-east-1.elb.amazonaws.com </p></div>`,
      });
    } catch (err) {
